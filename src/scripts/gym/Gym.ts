...
gymList['Oreburgh City'] = new Gym(
    ...
    'Oreburgh City',
    [
        new GymPokemon('Geodude', 100000, 12),
        new GymPokemon('Onix', 100000, 12),
        new GymPokemon('Cranidos', 100000, 14),
    ],
...
gymList['Eterna City'] = new Gym(
    ...
    'Eterna City',
    [
        new GymPokemon('Turtwig', 100000, 20),
        new GymPokemon('Cherrim', 100000, 20),
        new GymPokemon('Roserade', 100000, 22),
    ],
