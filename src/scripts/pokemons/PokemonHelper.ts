...
class PokemonHelper {
    ...
    public static getPokemonByName(name: string): DataPokemon {
        ...
        return new DataPokemon(basePokemon['id'], basePokemon['name'], basePokemon['catchRate'], basePokemon['evolutions'], type1, type2, basePokemon['attack'], basePokemon['levelType'], basePokemon['exp'], eggCycles, basePokemon['heldItem'], basePokemon['ability']);
    }
